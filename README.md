...
* Implemented thread synchronization using locks and condition variables  
* Extended virtual memory and process frame allocation  
* Worked inside a Java-based instructional OS environment

### **16-bit CPU Architecture & Assembler**

* Designed instruction set and datapath in Logisim  
* Built a Python assembler generating ROM images  
* Implemented control logic, memory, and execution flow

### **Collaborative Learning Platform (Django \+ React)**

* Designed backend API and relational schema  
